...
func SetupRoutes(db *sql.DB, cfg *config.Config) *mux.Router {
	...
	setupUserRoutes(v1, ctrls.UserController)
	setupCustomerRoutes(v1, ctrls.CustomerController)
...
func setupCustomerRoutes(v1 *mux.Router, customerController *controllers.CustomerController) {
...
func setupUserRoutes(v1 *mux.Router, userController *controllers.UserController) {
